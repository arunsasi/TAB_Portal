...
class CommonModel extends CI_Model
{
    ...
    public function selectDataCommon($table, $columns = null, $condition = null, $search_value = null, $search_like = null, $order_by = null, $limit = null, $joins = null, $where_in = null, $where_in_data = null, $where_not_in = null, $where_not_in_data = null)
    {
        ...
        if ($where_not_in !== null && (!empty($where_not_in_data))) {
            $this->db->where_not_in($where_not_in, $where_not_in_data);
        }
