...
--
-- Host: localhost:3306
-- Generation Time: Apr 16, 2019 at 12:22 AM
...
INSERT INTO `event_judges` (`id`, `judge_id`, `event_id`, `prilims`, `status`) VALUES
(1, 5, 4, 1, 99),
(2, 5, 2, 0, 1),
(3, 6, 2, 0, 1),
(4, 6, 4, 1, 1),
...
CREATE TABLE `events` (
  ...
  `status` int(11) NOT NULL COMMENT '0-active,1-judgement open,2-judgement closed, 3-Event finished(pre or final), 99-deleted',
  `created_date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
